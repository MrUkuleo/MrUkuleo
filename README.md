...
- Writing cross-platform applications on .NET;
- Creating Telegram bots in C# using the Telegram library.Bot;
- Working with HTML, CSS, JavaScript and React;
- Developing 2D games on Godot (using C#).

<h3 id="header">:hammer_and_wrench: Technologies and tools:</h3>
